...
export function createSlackServer(slackClient) {
    ...
    server.registerTool("slack_reply_to_thread", {
    ...
    server.registerTool("slack_get_channel_history", {
    ...
    server.registerTool("slack_get_thread_replies", {
    ...
    server.registerTool("slack_get_users", {
    ...
    server.registerTool("slack_get_user_profile", {
...
async function runStdioServer(slackClient) {
...
async function runHttpServer(slackClient, port = 3000, authToken) {
...
if (import.meta.url.startsWith('file://')) {
    ...
    const isMainModule = !isTestEnvironment && (currentFile === executedFile ||
